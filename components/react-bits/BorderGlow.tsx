/**
 * BorderGlow — edge-reactive glow card (React Bits).
 */
...
function parseHSL(hslStr: string) {
  ...
  if (!match) return { h: 215, s: 45, l: 58 };
  return {
...
export function BorderGlow({
  ...
  const handlePointerMove = useCallback(
    (e: MouseEvent<HTMLDivElement>) => {
      ...
      if (!card || pointerFrame.current) return;
    ...
    [getEdgeProximity, getCursorAngle, hoverCapable],
  );
