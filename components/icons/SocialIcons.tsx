/**
 * Official brand SVGs — rounded-square treatment for hero social links.
 */
...
export function FacebookIcon(props: IconProps) {
  return (
    <IconShell label="Facebook" {...props}>
...
export function SocialBrandIcon({
  ...
  const Icon = iconMap[name as keyof typeof iconMap] ?? GmailIcon;
